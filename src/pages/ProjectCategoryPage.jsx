    ...
    <section className="project-landing" aria-labelledby="project-category-title">
      ...
      {localizedProjects.length > 0 ? (
        <div className="projects-preview-grid">
          {localizedProjects.map((project) => <ProjectPreviewCard actionLabel={text.selected.link} categoryId={categoryId} headingLevel={2} key={project.id} project={project} showType={false} />)}
        </div>
