...
La cuadrícula de trabajos seleccionados debe cargar las imágenes locales desde `src/assets/images/selected-work` en este orden: Donas, Jardín web, Medusas y Ventti. Cada tarjeta mantiene su número, contenido localizado y diseño responsive existente.

## Criterios de aceptación

- El home muestra Donas, Jardín web, Medusas y Ventti en los puestos 01 a 04, respectivamente.
- Las imágenes se importan desde `src/assets/images/selected-work`.
